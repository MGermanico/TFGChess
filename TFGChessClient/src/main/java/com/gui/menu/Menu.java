...
public class Menu extends javax.swing.JPanel implements Requestable{
    ...
    private List<Action> actions = new ArrayList<Action>(){{
        add(new ActionPutFriends(Menu.this));
        add(new ActionPutFriendRequests(Menu.this));
        add(new ActionUpdateFriendRequestAlert(Menu.this));
        add(new ActionChatLog(Menu.this));
    }};
    ...
    private void updateButtons() {
        List.of(this.jButton1,this.jButton3,this.jButton4,this.friendRequestButton,this.showFriendRequestButton)
